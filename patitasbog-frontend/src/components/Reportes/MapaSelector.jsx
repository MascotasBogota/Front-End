...
const MapaSelector = ({ setUbicacion, ubicacionInicial }) => {
  return (
    <MapContainer center={ubicacionInicial || [4.711, -74.0721]} zoom={13} scrollWheelZoom={true} className="mapa">
      <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
      <LocationMarker setUbicacion={setUbicacion} ubicacionInicial={ubicacionInicial} />
    </MapContainer>
  )
}
