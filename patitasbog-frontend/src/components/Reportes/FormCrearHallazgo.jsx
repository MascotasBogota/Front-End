...
const FormCrearHallazgo = ({ onChangeSuccess, onChangeFail }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isValid) {
            ...
            try {
                ...
                //await reportService.markAsClosed(reportId); // ← aquí se cierra el reporte
                onChangeSuccess(
                    '¡Reporte de hallazgo creado y cerrado correctamente!',
                    'inicio',
                ...
                console.error(error);
                onChangeFail(
                    '¡Error al crear o cerrar el reporte!',
